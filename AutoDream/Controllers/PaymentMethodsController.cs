...
namespace AutoDream
{
    public class PaymentMethodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type, Sum, OrderId,WorkerId")] PaymentMethod paymentMethod, int OrderId)
        {
            if (ModelState.IsValid)
            {
                paymentMethod.OrderId = OrderId;
                paymentMethod.WorkerId = _context.Users.First(x => x.UserName == User.Identity.Name).Id;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,OrderId,WorkerId")] PaymentMethod paymentMethod)
        {
